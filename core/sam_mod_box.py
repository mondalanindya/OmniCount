...
output_path = str(OUTPUTS_ROOT / "FSC_test_split_single" / "sam_patches_box")
...
for cls_id in patches:
    ...
    for cls_name in os.listdir(mask_list):
        ...
        raw_image_list = os.path.join(raw_img_path, cls_id+'.jpg')
        refine_count(cls_id, patch_name_list, mask_name_list, cls_name_sep, prompt_type, annotations, raw_image_list)
